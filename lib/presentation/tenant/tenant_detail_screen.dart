  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(padding: S.pageAll, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      BBCard(child: Row(children: [
        ...
        IconButton(icon: const Icon(Icons.edit_outlined, size: 20, color: AppColors.primary), onPressed: () => navigator<NavigationService>().navigateTo(AppRoutes.agreementStep1, arguments: {'tenantId': tenant.id, 'edit': true})),
      ])),
...
class _AgrTabState extends State<_AgreementsTab> {
  ...
  @override Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(padding: S.pageAll, child: Column(children: [
      ...
      const SizedBox(height: 12),
      BBButton.secondary(label: 'ADD NEW AGREEMENT +', onPressed: () => navigator<NavigationService>().navigateTo(AppRoutes.agreementStep1, arguments: {'tenantId': widget.tenantId})),
    ]));
  }
